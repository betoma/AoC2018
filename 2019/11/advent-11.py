...
class PaintingRobot:
    def __init__(self,inputfile:str,starting_color=0):
        ...
        self.place = (0,0)
        self.facing = (0,1) #(0,1) is up, (0,-1) is down, (1,0) is right, (-1,0) is left
    ...
    def turn(self,n:int):
        if n == 0:
            ...
            raise ValueError("Something's borked! Your program shouldn't be outputting something that isn't 1 or 0.")

    def take_step(self):
        self.place = tuple(item1 + item2 for item1, item2 in zip(self.place,self.facing))
