    ...
    while True:
        ...
        for index, unit in enumerate(polymer):
            ...
            if pair_deleted:
                ...
                if ((this_unit.lower() == next_unit.lower()) and (differentCase(this_unit, next_unit))):
...
ordered_list_of_results = [(thing, unit_removal[thing]) for thing in sorted(unit_removal, key=unit_removal.get)]
