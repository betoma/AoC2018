...
print("{} slept for {} minutes, and was mostly frequently asleep at 00:{} ({} times).".format(sleepy_guard,sleepy_time,actual_minute,minute_frequency))
...
print("{} slept at 00:{} most often, {} times.".format(regular_sleeper,regular_minute,how_often))
